...
const highQualityImageXPath =
    '/html/body/div[15]/div[2]/div[3]/div/div/c-wiz/div/div[2]/div[2]/div/div[2]/c-wiz/div/div[2]/div[1]/a/img[1]';
...
const observer = new MutationObserver(() => {
    ...
    if (result.snapshotLength > 0) {
        ...
        // We click the image because we want the high quality version of the image.
        // All images in the grid view are low quality.
        // By clicking that image, it will open the high quality version of the image
    ...
    if (
        ...
        // Google places 2 images in a div, one above the other. They have a gstatic.com as
        // a backup image. We want the non-gstatic image which is the high quality one.
